...
packages <- c("ks", "plotrix", "lattice", "adehabitatHR", "maptools", "mapview", "raster", "ggplot2","colorRamps", "sf", "terra", "tmap", "stars")
```
...
#Alternative using Stars Package that I have not figured out yet - SMS
